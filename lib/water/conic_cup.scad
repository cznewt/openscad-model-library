...
cylinder(h=height+40+wall_thickness+1-3, r1=bottom_diameter-wall_thickness, r2=top_diameter-wall_thickness, $fn=sides);
...
cylinder(h=3, r1=3, r2=bottom_diameter-wall_thickness, $fn=sides);

translate([0,0,-1])
cylinder(h=wall_thickness+6, r1=3, r2=3, $fn=sides);
