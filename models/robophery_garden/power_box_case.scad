...
difference() {
    ...
    translate([boxWallThickness/2,27+0*32, 44]) rotate([90,90,270])
        connector_GSD4(boxWallThickness,boxClearance);

    translate([boxWallThickness/2,27+1*32, 44]) rotate([90,90,270])
        connector_GSD4(boxWallThickness,boxClearance);

    translate([boxWallThickness/2,27+2*32, 44]) rotate([90,90,270])
        connector_GSD4(boxWallThickness,boxClearance);

    translate([boxWallThickness/2,27+3*32, 44]) rotate([90,90,270])
        connector_GSD4(boxWallThickness,boxClearance);
